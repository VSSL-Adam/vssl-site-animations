  ...
  return (
    <div className="bg-dark_gray mx-auto my-16 w-10/12 p-6 sm:p-8 lg:p-12">
      <div className="border border-light_gray">
        <div className="flex border-b border-light_gray">
          <p className="border-r border-light_gray p-6 uppercase font-rift font-bold text-sm sm:text-lg text-light_gray">
            Client: {client}
          </p>
          <p className="p-6 uppercase font-rift font-bold text-sm sm:text-lg text-light_gray">
            Services:
            {tags.map((tag, index) => {
